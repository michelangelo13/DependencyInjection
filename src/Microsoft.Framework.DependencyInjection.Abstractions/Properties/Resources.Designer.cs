...
namespace Microsoft.Framework.DependencyInjection.Abstractions
{
    ...
    internal static class Resources
    {
        ...
        /// </summary>
        internal static string TryAddMultiRegistration_ImplementationTypeMustBeSet
        {
            get { return GetString("TryAddMultiRegistration_ImplementationTypeMustBeSet"); }
        }

        /// <summary>
        /// The {0} must have the {1} property set to a non-null value.
        /// </summary>
        internal static string FormatTryAddMultiRegistration_ImplementationTypeMustBeSet(object p0, object p1)
        {
            return string.Format(CultureInfo.CurrentCulture, GetString("TryAddMultiRegistration_ImplementationTypeMustBeSet"), p0, p1);
        }
